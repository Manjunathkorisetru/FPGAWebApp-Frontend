          ...
          <tr>
            ...
            {transceiverFlag ? (
              <>
                <TH colSpan="2">
                  Transceivers
                  <TH>SXT transceivers (28.3Gbps) </TH>
                  <TH>SX Transceivers (17.4Gbps)</TH>
                </TH>
              </>
            ) : (
              <></>
        ...
        <tbody>
          {props.posts.map((item, index) => (
            <tr key={item.id}>
              ...
              {transceiverFlag && (
                <>
                  <TD>{item.SXTTransceiverCount}</TD>
                  <TD>{item.SXTransceiverCount}</TD>
                </>
              )}
